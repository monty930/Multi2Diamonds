...
-- | Pretty-printer for Bridgelatte.

module Bridgelatte.Print where
...
instance Print Bridgelatte.Abs.ShapeDef where
  prt i = \case
    Bridgelatte.Abs.ShapeDef id_ shapes -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 shapes])
...
instance Print Bridgelatte.Abs.Expr where
  prt i = \case
    ...
    Bridgelatte.Abs.Not expr -> prPrec i 5 (concatD [doc (showString "not"), prt 6 expr])
    Bridgelatte.Abs.ERel expr1 relop expr2 -> prPrec i 2 (concatD [prt 2 expr1, prt 0 relop, prt 3 expr2])
    Bridgelatte.Abs.EAnd expr1 expr2 -> prPrec i 1 (concatD [prt 2 expr1, doc (showString "and"), prt 1 expr2])
    Bridgelatte.Abs.EOr expr1 expr2 -> prPrec i 0 (concatD [prt 1 expr1, doc (showString "or"), prt 0 expr2])

instance Print Bridgelatte.Abs.Hand where
  prt i = \case
    Bridgelatte.Abs.HandN -> prPrec i 0 (concatD [doc (showString "N")])
...
instance Print Bridgelatte.Abs.RelOp where
  prt i = \case
    Bridgelatte.Abs.LTH -> prPrec i 0 (concatD [doc (showString "<")])
    Bridgelatte.Abs.LE -> prPrec i 0 (concatD [doc (showString "<=")])
    Bridgelatte.Abs.GTH -> prPrec i 0 (concatD [doc (showString ">")])
    Bridgelatte.Abs.GE -> prPrec i 0 (concatD [doc (showString ">=")])
    Bridgelatte.Abs.EQU -> prPrec i 0 (concatD [doc (showString "==")])
    Bridgelatte.Abs.NE -> prPrec i 0 (concatD [doc (showString "!=")])
